    ...
    <section id="stack" className="py-24 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-3">
          {stack.map((s) => (
            <div key={s.name} className="flex items-start gap-4 p-4 rounded-lg border border-surface-border/50 hover:border-accent-blue/30 transition-colors bg-surface-light/30">
