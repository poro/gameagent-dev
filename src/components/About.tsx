  ...
  return (
    <section id="about" className="py-16 sm:py-24 px-4 sm:px-6">
      <div className="max-w-4xl mx-auto">
        ...
        {/* Terminal block */}
        <div className="mt-8 sm:mt-12 bg-surface-light border border-surface-border rounded-lg overflow-hidden">
          <div className="flex items-center gap-2 px-3 sm:px-4 py-2 bg-black/50 border-b border-surface-border">
            ...
            <span className="ml-2 text-[10px] sm:text-xs text-white/30 font-mono">~/gameagent</span>
          </div>
          <div className="p-3 sm:p-4 font-mono text-xs sm:text-sm space-y-1 overflow-x-auto">
