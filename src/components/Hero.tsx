export default function Hero() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      {/* Radial glow — clamped to viewport on mobile */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[min(800px,100vw)] h-[min(800px,100vw)] md:w-[800px] md:h-[800px] bg-accent/5 rounded-full blur-[120px]" />
      
      <div className="relative z-10 text-center px-6 sm:px-4 max-w-4xl">
        <div className="font-mono text-accent/60 text-xs sm:text-sm mb-4 sm:mb-6 tracking-widest">
        ...
        <p className="text-base sm:text-lg md:text-xl text-white/50 max-w-2xl mx-auto mb-3 sm:mb-4 leading-relaxed">
        ...
        <div className="font-mono text-[10px] sm:text-xs text-white/20 mb-8 sm:mb-10">
        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
          <a
            ...
            target="_blank"
            rel="noopener"
            className="inline-flex items-center justify-center gap-2 px-8 py-3.5 sm:py-3 bg-accent text-black font-mono font-bold text-sm rounded hover:bg-accent/90 transition-all hover:shadow-[0_0_30px_rgba(0,255,136,0.3)] active:scale-95"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener"
            className="inline-flex items-center justify-center gap-2 px-8 py-3.5 sm:py-3 border border-accent/30 text-accent font-mono font-bold text-sm rounded hover:bg-accent/10 transition-all active:scale-95"
          >
